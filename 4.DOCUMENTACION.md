...
- También llamado __code smell__ en inglés ( el programa funciona bien pero el código no está bien desarrollado)
...
- Tipos:
  - __Análisis dinámico__ (unit tests): analizar el funcionamiento del código.
...
- __Es el proceso de reestructurar un código fuente, alterando su estructura interna sin cambiar su comportamiento externo.__
- Técnicas:
